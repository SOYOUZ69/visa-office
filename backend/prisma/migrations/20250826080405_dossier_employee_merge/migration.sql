...
-- AddForeignKey
ALTER TABLE "public"."dossier_employee_assignments" ADD CONSTRAINT "dossier_employee_assignments_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "public"."clients"("id") ON DELETE SET NULL ON UPDATE CASCADE;
