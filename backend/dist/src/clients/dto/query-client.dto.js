...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: client_1.ClientStatus }),
    (0, class_validator_1.IsEnum)(client_1.ClientStatus),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], QueryClientDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: client_1.ClientType }),
    (0, class_validator_1.IsEnum)(client_1.ClientType),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], QueryClientDto.prototype, "clientType", void 0);
__decorate([
