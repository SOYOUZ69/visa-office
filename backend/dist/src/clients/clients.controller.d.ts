...
export declare class ClientsController {
    ...
    createPhoneCallClient(createPhoneCallClientDto: CreatePhoneCallClientDto): Promise<({
        phoneNumbers: {
            number: string;
            id: string;
            clientId: string;
    ...
    addFamilyMember(id: string, createFamilyMemberDto: CreateFamilyMemberDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        fullName: string;
    ...
    assignEmployee(clientId: string, body: {
        employeeId: string;
    }): Promise<{
        phoneNumbers: {
            number: string;
